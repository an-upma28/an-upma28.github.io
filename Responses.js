    ...
    [
        {
            ...
            answer : "Electric Current is defined as the rate of flow of charges through a conductor. Rate of flow means, the amount of charge flowing through a particular area of a conductor in unit time. By convention, electric current flows in the opposite direction to the movement of electrons. <br> Symbol : I/i <br>SI unit : Ampere (A) <br>Formula : i = Q/t <br>Where i is electric current, Q is net charge and t is a time in second.<br> Device used to measure : Ammeter" 
        },
        
        {
            question : "what potential difference",
            answer : "Potential difference is the work done in moving a unit of positive electric charge from one point to another.<br> Symbol : V <br>SI unit : Volt (V) <br>Formula : V = W/Q <br>Where W is the work done to move  the charge and Q is the total amount of charge moved <br> Device used to measure : Voltmeter"
        },


        {
            question : "hi",
            answer : "<b> Ohm's Law</b><br>Ohm's law states that the current flowing through the conductor is directly proportional to the voltage across its two ends, provided all physical conditions and temperatures remain constant. <br> V = IR <br><br> Here is a graph between the Voltage and Current in a Ohmic Conductor (conductor that obeys ohm's law). The linear curve proves that the voltage and current in a conductor are propertional",
            image : "C:/Users/banana/Desktop/Coding/CODEX/MeraBot/media/images/OhmsLaw.jpg"
        },

        {
            question : "differentiate resistance resistivity",
            table : 
            [
                [
                    ['RESISTANCE'],
...

        {
            ...
            BotQues : ["Would you like to know more about field lines?","redirect", "magnetic field lines" ]
        },

        {
            ...
            image : '"C:/Users/banana/Desktop/Coding/CODEX/MeraBot/media/images/FieldLines.png"',
            BotQues : ["Would you like to know more about the magnetic effect of electric current?","redirect", "magnetic effect of current" ]
        },  


        {
            question : "magnetic effect of current",
            ...
            BotQues : ["Would you like to know more about Oersted's experiment ?" , "redirect", "oersteds experiment"]
        },

        {
            question : "oersteds experiment",
            ...
            image: "'C:/Users/banana/Desktop/Coding/CODEX/MeraBot/media/images/oersted.png'"
        },

        {
            question : "structure of an atom",
            ...
            image : "'C:/Users/banana/Desktop/Coding/CODEX/MeraBot/media/images/Atom.jpg'",
            video :  '"C:/Users/banana/Desktop/Coding/CODEX/MeraBot/media/videos/Atom.mp4"',
        },

        {
            question : "daltons atomic theory",
        ...
        },
        {
            ...
            video : '"C:/Users/banana/Desktop/Coding/CODEX/MeraBot/media/videos/molecule.mp4"',
            BotQues : ["Would you like to know about chemical bonds and how molecules are formed?","redirect", 'chemical bonds' ]
        },

        {
            ...
            video : '"C:/Users/banana/Desktop/Coding/CODEX/MeraBot/media/videos/bonding.mp4"',
...

        {
            ...
            BotQues : ["Would you like to know more about steps involved in photosynthesis?", "redirect", "steps involved in photosynthesis"]

        },

        {
            question : "steps involved in photosynthesis",
        ...
        {
            question : "parts of the digestive system",
            ...
            image : "'C:/Users/banana/Desktop/Coding/CODEX/MeraBot/media/images/digestion.jpg'",
            BotQues : ["Would you like to know more about the process of digestion?", "redirect", "process of digestion"]

        },

        {
            question : "process of digestion",
            ...
            BotQues : ["Would you like to watch a video that explains the process of digestion?","video", '"C:/Users/banana/Desktop/Coding/CODEX/MeraBot/media/videos/digestion.mp4"' ]
        },

        {
            question : "excretary system",
            ...
            image : "'C:/Users/banana/Desktop/Coding/CODEX/MeraBot/media/images/excretary.jpg'"
        },

        {
            question : "functioning of heart",
            ...
            image : "'C:/Users/banana/Desktop/Coding/CODEX/MeraBot/media/images/heart.jpg'",
            BotQues : ["Would you like to watch a video that explains functioning of heart?","video", '"C:/Users/banana/Desktop/Coding/CODEX/MeraBot/media/videos/heart.mp4"' ]
...
{
    QList.push(json.questions[i].question)
    i++
}
console.log(QList)